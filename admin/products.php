      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<div class="row">
				...
				<div class="clearfix"></div>
				<h4>All Products</h4>
				<div class="col-md-4 col-sm-6 col-xs-12 no-padding custom-search">
					<input type="text" class="form-control" id="search-field" placeholder="Serach By Product Name"><br>
					<div class="search_result">
						
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="col-md-12 table-responsive" id="search_result">
					<?php
					...
					$all_pro_sql="SELECT * FROM products ORDER BY pid DESC";
